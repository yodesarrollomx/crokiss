# CroKiss — historia del documento anterior (hasta 2026-07-26)

> Este archivo conserva el CLAUDE.md que existía antes de reordenarlo a la mecánica del expediente
> (4-sep-2026). **No se borró nada:** aquí está completo el detalle de las fases P0–P6, el enjambre
> de UX, las condiciones del comité de inversión y los bugs cerrados. El documento vigente es
> `../CLAUDE.md`; esto es su respaldo histórico.
