...
1. Sube **todos** los archivos modificados/nuevos al repo `yodesarrollomx/crokiss` (rama principal):
...
3. Abre https://yodesarrollomx.github.io/crokiss/ y recarga con **Ctrl+Shift+R** (recarga dura).
